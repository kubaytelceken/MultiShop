...
namespace MultiShop.IdentityServerdotnet
{
    public static class Config
    {
        ...
        {
            //apiresource cagırıldıugı zaman her bir microservis için o servise erişim için bir key belirleyecegiz.
        ...
        {
            // identity kaynagına sahip kişi hangi değerlere sahip olacak.
